                ...
                >
                    <div class=" p-8 rounded-2xl md:w-2/3 ">
                        <form
                            ...
                            <div class="bg-green-500 rounded-t-3xl p-2 text-center">
                                {{form.start + '-' + form.end}}
                            </div>
                            ...
                            <div class="flex justify-between">
                                <button type="submit" class="bg-green-500 w-1/4 h-10 rounded-bl-xl mt-5" :disabled="form.processing">Submit</button>
                                <button type="button"
